...
def probe_trajectory target
    ...
    (target_x_max + 1).times do |x_velocity|

        y_velocity = target_y_min
        ...
        # 163.times do |y_velocity|
            ...
            all_velocities.push(velocity) if in_target
        ...
        # end
            y_velocity += 1
            break if y_velocity > target_y_min.abs
        end

    end
    # all_velocities.each {|v| p v}
    p all_velocities.length
